...
# pwsh scripts/retrieve-secrets.ps1 -Project $project -Secret 'kene-cicd-local' -Impersonate 'terraform-reader'

# pwsh scripts/retrieve-secrets.ps1 -Project $project -Secret 'kene-cicd-local'
...
minikube start --profile $profile  --memory=8192 --cpus=6
